...
include_once($path); ?>
<title>Carbon Cycle Simulation - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp carbon-sim">
      ...
      <div class="hero-content">
        <div class="info-panel">
          <ul class="breadcrumbs">
            ...
            <li>Play</li>
            <img class="breadcrumb-arrow" src="../../assets/img/ui/breadcrumb-arrow.png">
            <li>Carbon Cycle Simulation</li>
          </ul>
        </div>
        <div class="app-info">
          <h1 class="app-title">Carbon Cycle Simulation</h1>
        </div>
        <div class="app-description">
          <p class="small">
            Use this playful simulation to teach the carbon cycle! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
    ...
    <section id="app-about" class="app-about">
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <p>
            Learn how carbon moves through the ecosystem! In this game, players trigger events—like the burning of fossil fuel—and watch how the carbon moves among the air, ocean, rocks, and living things.
          </p>
