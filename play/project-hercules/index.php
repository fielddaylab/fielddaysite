...
<title>Project Hercules</title>
<meta name="description" content="Project Hercules is a game about astronomy, and love, and distance, and the apocalypse, and parental relationships, and isolation, and mythology, and letters, and computers, and probably a bunch of other things I’m forgetting." />
...
<section class="app-hero">
  <div class="hero-content">
    ...
    <div class="app-description"><p class="small">Project Hercules is a game about astronomy, and love, and distance, and the apocalypse, and parental relationships, and isolation, and mythology, and letters, and computers, and probably a bunch of other things I’m forgetting.</p></div>
    <div class="buttons">
              <a id = "playButton" class="button small white filled" href="https://fielddaylab.wisc.edu/play/project-hercules/ci/production/" target="_blank">Play Project Hercules</a>
  ...
  <div class="row container">
    <div class="col-sm-4">
      <div class="about-nav follow-scroll">
        ...
        <li><a href="#content">Content Areas</a></li>
    ...
    <div id="glance" class="col-sm-8 about-rightpanel">
      <div id="app-video" class="app-video">
          <div class='embed-container'>
              <iframe src="https://player.vimeo.com/video/1018790859" width="100%" frameborder="0" allowfullscreen></iframe>
          </div>
      </div>
      ...
      <p>In Bloom: The Saga of the <s>Poop</s> Fertilizer Economy, players serve as the director of SAGA:The Sustainable Agricultural Growth Administration. In this role, their goal is to foster economic growth across five different counties while reducing agricultural runoff and gross algal blooms. To win, players must develop local trade networks, employ a range of economic and environmental policies, and balance the needs and perspectives of bickering townsfolk. A key focus of the game is learning about the relationship between agricultural runoff and water quality, while exploring how markets that allow farmers to sell excess manure can lead to cleaner water and economic sustainability. 
</p>
      <h2 id="gameplay">Gameplay</h2>
      <p>As the director of SAGA, players can use tax revenues to build roads (and other infrastructure) and enact economic and environmental policies. Their objective is to create local trade networks and utilize new technologies to develop a fertilizer market, whereby excess manure can be bought and sold, rather than inefficiently spread on fields. </p>
      ...
      <h2 id="standards">Academic Standards</h2>
                    ...
                    <div class="row standards-block">
                        <div class="col-sm-7">
                            ...
                            <p class="small"><span class="bold">Stability and Change - Standard SCI.CC7</span><br>Students use science and engineering practices, disciplinary core ideas, and an understanding of stability and change to make sense of phenomena and solve problems.</p>
                        </div>
                    </div>
