...
include_once($path); ?>
<title>Wind Simulator - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp yard wind">
    ...
    <section class="app-hero">
      <div class="hero-content">
        ...
        <div class="buttons">
          ...
          <a target="_blank" href="https://theyardgames.org/game/wind.html" class="button xsmall white">Play the Game</a>
        </div>
      </div>
    </section>
