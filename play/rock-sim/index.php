...
include_once($path); ?>
<title>Rock Cycle Simulation - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp rock-sim">
      ...
      <div class="hero-content">
        <div class="info-panel">
          <ul class="breadcrumbs">
            ...
            <li>Play</li>
            <img class="breadcrumb-arrow" src="../../assets/img/ui/breadcrumb-arrow.png">
            <li>Rock Cycle Simulation</li>
          </ul>
        </div>
        <div class="app-info">
          <h1 class="app-title">Rock Cycle Simulation</h1>
        </div>
        <div class="app-description">
          <p class="small">
            Learn how rocks and minerals move through the ecosystem! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
    ...
    <section id="app-about" class="app-about">
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <p>
            Learn about how rocks and minerals form from one another! In this playful simulation, players choose transitional events, like a volcanic eruption or the formation of volcanic rock, and explore how rocks and minerals move through the world.
          </p>
