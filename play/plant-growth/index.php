...
include_once($path); ?>
<title>Plant Growth - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp plant-growth">
  ...
  ------------------------>
    <section class="app-hero">
      <div class="hero-content">
        ...
        <div class="app-info">
          <h1 class="app-title">Plant Growth</h1>
        </div>
        <div class="app-description">
          <p class="small">
            A playful simulation to teach the life cycle of plants! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
    ...
    <section id="app-about" class="app-about">
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <p>
            Check out how environmental factors affect plant growth! Set variables, choose actions (like “Send in bees” or “Windy weather”) and then launch the simulation. Watch your plant move from a tiny seed to a flowering plant, and then start again with a new seed—if it survives that long.
          </p>
