...
include_once($path); ?>
<title>Energy in Food Webs - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp food-webs">
      ...
      <div class="hero-content">
        <div class="info-panel">
          <ul class="breadcrumbs">
            ...
            <li>Play</li>
            <img class="breadcrumb-arrow" src="../../assets/img/ui/breadcrumb-arrow.png">
            <li>Energy in Food Webs</li>
          </ul>
        </div>
        <div class="app-info">
          <h1 class="app-title">Energy in Food Webs</h1>
        </div>
        <div class="app-description">
          <p class="small">
            Learn how energy moves through food webs! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
    ...
    <section id="app-about" class="app-about">
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <p>
            This simulator shows how energy from the sun and from geologic thermal processes flows through living things. Use nodes and arrows to trigger the movement of energy through food webs, from the sun to plants to herbivores, all the way up to apex predators, and then back to the soil again.
          </p>
