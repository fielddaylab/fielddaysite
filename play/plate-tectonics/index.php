...
include_once($path); ?>
<title>Plate Tectonics - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp plate-tectonics">
  ...
  ------------------------>
    <section class="app-hero">
      <div class="hero-content">
        ...
        <div class="app-info">
          <h1 class="app-title">Plate Tectonics</h1>
        </div>
        <div class="app-description">
          <p class="small">
            Use this fun simulation to teach magma flow and Earth’s tectonic plates. Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
