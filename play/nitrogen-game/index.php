...
include_once($path); ?>
<title>Nitrogen Cycle Game - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp yard nitrogen-game">
    ...
    <section class="app-hero">
      <div class="hero-content">
        ...
        <div class="buttons">
          ...
          <a target="_blank" href="https://theyardgames.org/game/nitrogen.html" class="button xsmall white">Play the Game</a>
        </div>
      </div>
    </section>
