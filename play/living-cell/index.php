...
include_once($path); ?>
<title>Living Cell - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp living-cell">
  ...
  ------------------------>
    <section class="app-hero">
      <div class="hero-content">
        ...
        <div class="app-info">
          <h1 class="app-title">Living Cell</h1>
        </div>
        <div class="app-description">
          <p class="small">
            This interactive simulation teaches cellular metabolism! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
