...
include_once($path); ?>
<title>Carbon Cycle Game - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp yard carbon-game">
      ...
      <div class="hero-content">
        <div class="info-panel">
          <ul class="breadcrumbs">
            ...
            <li>Play</li>
            <img class="breadcrumb-arrow" src="../../assets/img/ui/breadcrumb-arrow.png">
            <li>Carbon Cycle Game</li>
            <a class="app-logo" target="_blank" href="https://theyardgames.org/"><img src="/assets/img/logos/yard-logo.png" /></a>
          </ul>
        </div>
        <div class="app-info">
          <h1 class="app-title">Carbon Cycle Game</h1>
        </div>
        <div class="app-description">
          <p class="small">
            This game introduces kids to the carbon cycle! Made with our partners at Wisconsin DPI and Wisconsin Virtual Schools.
          </p>
        </div>
        <div class="buttons">
          ...
          <a target="_blank" href="https://theyardgames.org/game/carbon.html" class="button xsmall white">Play the Game</a>
        </div>
      </div>
    </section>
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <ul>
            ...
            <li>Cycles of Matter and Energy Transfer in Ecosystems</li>
          </ul>
          ...
          <p>
            Carbon Cycle is part of the Yard Games, our collection of middle school science games. Designed as playful introductions to complex topics, the games are online and free to play.
