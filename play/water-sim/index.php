...
include_once($path); ?>
<title>Water Cycle Simulation - Field Day</title>
<meta name="description" content="- Field Day">
</head>

<body class="singleapp water-sim">
      ...
      <div class="hero-content">
        <div class="info-panel">
          <ul class="breadcrumbs">
            ...
            <li>Play</li>
            <img class="breadcrumb-arrow" src="../../assets/img/ui/breadcrumb-arrow.png">
            <li>Water Cycle Simulation</li>
          </ul>
        </div>
        <div class="app-info">
          <h1 class="app-title">Water Cycle Simulation</h1>
        </div>
        <div class="app-description">
          <p class="small">
            Use this playful simulation to dive into the water cycle! Made with our partners at BrainPOP.
          </p>
        </div>
        <div class="buttons">
    ...
    <section id="app-about" class="app-about">
      ...
      <div class="row container">
        ...
        <div id="glance" class="col-sm-8 about-rightpanel">
          ...
          <p>
            This playful simulation is an introduction to the water cycle! Players trigger events and trace how water moves through the atmosphere, bodies of water, living things, and more.
          </p>
