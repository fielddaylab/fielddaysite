...
<?php $path = $_SERVER['DOCUMENT_ROOT']; $path .= "/includes/main-nav.php";  include_once($path); ?>
  ...
  <section class="singlehero page_hero">
    ...
    <nav class="nav nav-tabs press-toggles">
      <ul>
        <li class="press-toggle press-toggle3 active"><a href="#approach" role="tab" data-toggle="tab">Story and Stats</a></li>
        <li class="press-toggle press-toggle1"><a href="#projects" role="tab" data-toggle="tab">Press</a></li>
        <li class="press-toggle press-toggle2"><a href="#publications" role="tab" data-toggle="tab">Mark Usage</a></li>
    ...
    <div role="tabpanel" class="tab-pane fade in active" id="approach">
      <div class="row">
        <div class="pub-nav-wrap sticky col-sm-3">
          <div class="pub-nav">
            <ul>
              <li><a href="#whatis">What is Field Day?</a></li>
              <li><a href="#stats">Play Stats</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-9">
      ...
      <section class="publications">
        <div class="row">
          <div class="pub-nav-wrap sticky col-sm-3">
            <div class="pub-nav">
              <ul>
                <li><a href="#pub1">Press and Articles</a></li>
                <li><a href="#pub2">Awards</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-9">
            <!--<h2 id="pub1">Press and Articles</h2>
            <div class="pub-wrap">
              <p class="small">
    ...
    <div role="tabpanel" class="tab-pane fade" id="publications">
      <div class="row">
        <div class="pub-nav-wrap sticky col-sm-4">
          <div class="pub-nav">
            <ul>
              <li><a href="#pub4">Logo guidelines</a></li>
              <li><a href="#pub5">Logo downloads</a></li>
            </ul>
          </div>
        </div>
        <div class="col-sm-8">
