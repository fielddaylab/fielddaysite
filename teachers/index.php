        ...
        <div class=" questions">
          <ul class="carousel-indicators">
              <li class="active" data-target="#faq" data-slide-to="0">
                What do I get paid for joining a fellowship?
              </li>
      ...
      <ul class="gridder">
        ...
        <li class="gridder-list" data-griddercontent="#game15">
          <div class="game-thumbnail">
            <img src="/assets/img/illustrations/mountainrange-dark.png">
          </div>
          <div class="card-summary">
            <div class="info">
              <h3>Open Game Data Fellowship</h3>
              <h4 class="date">Summer 2020</h4>
...
<div id="game15" class="gridder-content">
  <div class="row game-inner game15-inner">
    <h3>Open Game Data Fellowship</h3>
    <span>Deadline: January 10, 2020</span>
    ...
    <div class="wrapper">
      ...
      <div class="col-md-5 cta">
        <img class="expanded-thumb img-responsive" src="/assets/img/illustrations/mountainrange-dark.png">
      </div>
    </div>
  </div>
</div>
...
<div id="game13" class="gridder-content fellowship-finished">
  <div class="row game-inner game13-inner">
    ...
    <a class="button small black" href="https://medium.com/fielddaylab/shipwrecks-and-sea-shanties-designing-a-game-to-teach-the-great-lakes-3339abddd865" target="_blank">Read the Story</a>
    </div>
  </div>
</div>
...
<a target="_blank" href="https://fielddaylab.wisc.edu/courses/play-games">online course</a>
</p>
    </div>
  </div>
</div>
...
<div id="game0" class="gridder-content fellowship-finished">
  <div class="row game-inner game0-inner">
    ...
    <div class="col-md-6 cta fellowship-summary">
      ...
      <a class="button small black" href="https://medium.com/fielddaylab/kids-in-verona-wisconsin-use-siftr-to-write-poetry-b8e14fa6f147?#.z23kxu4ja " target="_blank">Read the Story</a>
    </div>
  </div>
</div>
</div>
...
<script>
  ...
  sr.reveal('.upreveal', upreveal, { viewFactor: 0.8 });
